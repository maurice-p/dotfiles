...
Please see [./CONTRIBUTING.md](https://github.com/augustocdias/vscode-shell-command/blob/HEAD/CONTRIBUTING.md) for documentation on developing this extension.

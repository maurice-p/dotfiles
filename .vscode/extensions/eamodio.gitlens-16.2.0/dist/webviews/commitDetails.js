...
`);var qs=Object.defineProperty,Vs=Object.getOwnPropertyDescriptor,Ws=(e,t,o,n)=>{for(var r,a=n>1?void 0:n?Vs(t,o):t,l=e.length-1;l>=0;l--)(r=e[l])&&(a=(n?r(t,o,a):r(a))||a);return n&&a&&qs(t,o,a),a};let Gs=class extends lit_element_r{constructor(){super(...arguments),this.mode="infinite",this.active=!1,this.position="bottom"}firstUpdated(){this.setAttribute("role","progressbar")}render(){return Yt`<div class="progress-bar"></div>`}};Gs.styles=pt`
	...
	`,nr([gi({flatten:!0})],sr.prototype,"actionNodes",2),sr=nr([ai("action-nav")],sr);const rr=new WeakMap;function ar(e,t){return function(o,n,r){let a=rr.get(o.constructor);null==a&&rr.set(o.constructor,a=[]),a.push({method:r.value,keys:Array.isArray(e)?e:[e],afterFirstUpdate:t?.afterFirstUpdate??!1})}}class GlElement extends lit_element_r{emit(e,t,o){const n=new CustomEvent(e,{bubbles:!0,cancelable:!1,composed:!0,...o,detail:t});return this.dispatchEvent(n),n}update(e){const t=rr.get(this.constructor);if(null!=t)for(const{keys:o,method:n,afterFirstUpdate:r}of t){if(r&&!this.hasUpdated)continue;const t=o.filter((t=>e.has(t)));t.length&&n.call(this,t)}super.update(e)}}var lr=Object.defineProperty,cr=Object.getOwnPropertyDescriptor,dr=(e,t,o,n)=>{for(var r,a=n>1?void 0:n?cr(t,o):t,l=e.length-1;l>=0;l--)(r=e[l])&&(a=(n?r(t,o,a):r(a))||a);return n&&a&&lr(t,o,a),a};const hr={".":"Unchanged","!":"Ignored","?":"Untracked",A:"Added",D:"Deleted",M:"Modified",R:"Renamed",C:"Copied",AA:"Conflict",AU:"Conflict",UA:"Conflict",DD:"Conflict",DU:"Conflict",UD:"Conflict",UU:"Conflict",T:"Modified",U:"Updated but Unmerged"};let pr=class extends lit_element_r{get statusName(){return this.status?hr[this.status]:""}updated(e){super.updated(e),e.has("status")&&(this.statusName?this.setAttribute("title",this.statusName):this.removeAttribute("title"))}renderIgnored(){return Yt`
		...
		`],dr([di()],pr.prototype,"status",2),dr([hi()],pr.prototype,"statusName",1),pr=dr([ai("gl-git-status")],pr);const ur=[Fs,pt``],gr=[Fs,pt`
		:host {

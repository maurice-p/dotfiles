...
`;var lo=Object.defineProperty,co=Object.defineProperties,ho=Object.getOwnPropertyDescriptor,po=Object.getOwnPropertyDescriptors,uo=Object.getOwnPropertySymbols,go=Object.prototype.hasOwnProperty,mo=Object.prototype.propertyIsEnumerable,fo=e=>{throw TypeError(e)},bo=(e,t,o)=>t in e?lo(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o,vo=(e,t)=>{for(var o in t||(t={}))go.call(t,o)&&bo(e,o,t[o]);if(uo)for(var o of uo(t))mo.call(t,o)&&bo(e,o,t[o]);return e},yo=(e,t)=>co(e,po(t)),wo=(e,t,o,i)=>{for(var r,s=i>1?void 0:i?ho(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(i?r(t,o,s):r(s))||s);return i&&s&&lo(t,o,s),s},xo=(e,t,o)=>t.has(e)||fo("Cannot "+o),ko=new Map,$o=new WeakMap;function _o(e){return null!=e?e:{keyframes:[],options:{duration:0}}}function Po(e,t){return"rtl"===t.toLowerCase()?{keyframes:e.rtlKeyframes||e.keyframes,options:e.options}:e}function Co(e,t){ko.set(e,_o(t))}function So(e,t,o){const i=$o.get(e);if(null==i?void 0:i[t])return Po(i[t],o.dir);const r=ko.get(t);return r?Po(r,o.dir):{keyframes:[],options:{duration:0}}}var Ro=p`
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
    --show-delay: 150ms;
...
`;const Oo=new Set,To=new Map;let Do,Eo="ltr",Lo="en";const zo="undefined"!=typeof MutationObserver&&"undefined"!=typeof document&&void 0!==document.documentElement;if(zo){const e=new MutationObserver(Io);Eo=document.documentElement.dir||"ltr",Lo=document.documentElement.lang||navigator.language,e.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]})}function Fo(...e){e.map((e=>{const t=e.$code.toLowerCase();To.has(t)?To.set(t,Object.assign(Object.assign({},To.get(t)),e)):To.set(t,e),Do||(Do=e)})),Io()}function Io(){zo&&(Eo=document.documentElement.dir||"ltr",Lo=document.documentElement.lang||navigator.language),[...Oo.keys()].map((e=>{"function"==typeof e.requestUpdate&&e.requestUpdate()}))}class LocalizeController{constructor(e){this.host=e,this.host.addController(this)}hostConnected(){Oo.add(this.host)}hostDisconnected(){Oo.delete(this.host)}dir(){return`${this.host.dir||Eo}`.toLowerCase()}lang(){return`${this.host.lang||Lo}`.toLowerCase()}getTranslationData(e){var t,o;const i=new Intl.Locale(e.replace(/_/g,"-")),r=null==i?void 0:i.language.toLowerCase(),s=null!==(o=null===(t=null==i?void 0:i.region)||void 0===t?void 0:t.toLowerCase())&&void 0!==o?o:"";return{locale:i,language:r,region:s,primary:To.get(`${r}-${s}`),secondary:To.get(r)}}exists(e,t){var o;const{primary:i,secondary:r}=this.getTranslationData(null!==(o=t.lang)&&void 0!==o?o:this.lang());return t=Object.assign({includeFallback:!1},t),!!(i&&i[e]||r&&r[e]||t.includeFallback&&Do&&Do[e])}term(e,...t){const{primary:o,secondary:i}=this.getTranslationData(this.lang());let r;if(o&&o[e])r=o[e];else if(i&&i[e])r=i[e];else{if(!Do||!Do[e])return String(e);r=Do[e]}return"function"==typeof r?r(...t):r}date(e,t){return e=new Date(e),new Intl.DateTimeFormat(this.lang(),t).format(e)}number(e,t){return e=Number(e),isNaN(e)?"":new Intl.NumberFormat(this.lang(),t).format(e)}relativeTime(e,t,o){return new Intl.RelativeTimeFormat(this.lang(),o).format(e,t)}}var Wo={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(e,t)=>`Go to slide ${e} of ${t}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:e=>0===e?"No options selected":1===e?"1 option selected":`${e} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:e=>`Slide ${e}`,toggleColorFormat:"Toggle color format"};Fo(Wo);var Bo=Wo,Mo=class extends LocalizeController{};Fo(Bo);var Uo,jo=p`
  :host {
    box-sizing: border-box;
  }
...
`,Vo=class extends lit_element_r{constructor(){var e,t,o;super(),e=this,o=!1,(t=Uo).has(e)?fo("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach((([e,t])=>{this.constructor.define(e,t)}))}emit(e,t){const o=new CustomEvent(e,vo({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(o),o}static define(e,t=this,o={}){const i=customElements.get(e);if(!i){try{customElements.define(e,t,o)}catch(i){customElements.define(e,class extends t{},o)}return}let r=" (unknown version)",s=r;"version"in t&&t.version&&(r=" v"+t.version),"version"in i&&i.version&&(s=" v"+i.version)}attributeChangedCallback(e,t,o){var i,r,s;xo(i=this,r=Uo,"read from private field"),(s?s.call(i):r.get(i))||(this.constructor.elementProperties.forEach(((e,t)=>{e.reflect&&null!=this[t]&&this.initialReflectedProperties.set(t,this[t])})),((e,t,o,i)=>{xo(e,t,"write to private field"),i?i.call(e,o):t.set(e,o)})(this,Uo,!0)),super.attributeChangedCallback(e,t,o)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach(((t,o)=>{e.has(o)&&null==this[o]&&(this[o]=t)}))}};Uo=new WeakMap,Vo.version="2.19.1",Vo.dependencies={},wo([be()],Vo.prototype,"dir",2),wo([be()],Vo.prototype,"lang",2);const No=Math.min,Ho=Math.max,Go=Math.round,qo=Math.floor,Qo=e=>({x:e,y:e}),Yo={left:"right",right:"left",bottom:"top",top:"bottom"},Ko={start:"end",end:"start"};function Jo(e,t,o){return Ho(e,No(t,o))}function Zo(e,t){return"function"==typeof e?e(t):e}function Xo(e){return e.split("-")[0]}function ei(e){return e.split("-")[1]}function ti(e){return"x"===e?"y":"x"}function oi(e){return"y"===e?"height":"width"}function ii(e){return["top","bottom"].includes(Xo(e))?"y":"x"}function ri(e){return ti(ii(e))}function ni(e){return e.replace(/start|end/g,(e=>Ko[e]))}function si(e){return e.replace(/left|right|bottom|top/g,(e=>Yo[e]))}function ai(e){return"number"!=typeof e?function(e){return{top:0,right:0,bottom:0,left:0,...e}}(e):{top:e,right:e,bottom:e,left:e}}function li(e){const{x:t,y:o,width:i,height:r}=e;return{width:i,height:r,top:o,left:t,right:t+i,bottom:o+r,x:t,y:o}}function ci(e,t,o){let{reference:i,floating:r}=e;const s=ii(t),a=ri(t),l=oi(a),c=Xo(t),d="y"===s,h=i.x+i.width/2-r.width/2,p=i.y+i.height/2-r.height/2,u=i[l]/2-r[l]/2;let g;switch(c){case"top":g={x:h,y:i.y-r.height};break;case"bottom":g={x:h,y:i.y+i.height};break;case"right":g={x:i.x+i.width,y:p};break;case"left":g={x:i.x-r.width,y:p};break;default:g={x:i.x,y:i.y}}switch(ei(t)){case"start":g[a]-=u*(o&&d?-1:1);break;case"end":g[a]+=u*(o&&d?-1:1)}return g}async function di(e,t){var o;void 0===t&&(t={});const{x:i,y:r,platform:s,rects:a,elements:l,strategy:c}=e,{boundary:d="clippingAncestors",rootBoundary:h="viewport",elementContext:p="floating",altBoundary:u=!1,padding:g=0}=Zo(t,e),m=ai(g),f=l[u?"floating"===p?"reference":"floating":p],v=li(await s.getClippingRect({element:null==(o=await(null==s.isElement?void 0:s.isElement(f)))||o?f:f.contextElement||await(null==s.getDocumentElement?void 0:s.getDocumentElement(l.floating)),boundary:d,rootBoundary:h,strategy:c})),y="floating"===p?{x:i,y:r,width:a.floating.width,height:a.floating.height}:a.reference,w=await(null==s.getOffsetParent?void 0:s.getOffsetParent(l.floating)),x=await(null==s.isElement?void 0:s.isElement(w))&&await(null==s.getScale?void 0:s.getScale(w))||{x:1,y:1},$=li(s.convertOffsetParentRelativeRectToViewportRelativeRect?await s.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:y,offsetParent:w,strategy:c}):y);return{top:(v.top-$.top+m.top)/x.y,bottom:($.bottom-v.bottom+m.bottom)/x.y,left:(v.left-$.left+m.left)/x.x,right:($.right-v.right+m.right)/x.x}}function hi(){return"undefined"!=typeof window}function pi(e){return mi(e)?(e.nodeName||"").toLowerCase():"#document"}function ui(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function gi(e){var t;return null==(t=(mi(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function mi(e){return!!hi()&&(e instanceof Node||e instanceof ui(e).Node)}function fi(e){return!!hi()&&(e instanceof Element||e instanceof ui(e).Element)}function bi(e){return!!hi()&&(e instanceof HTMLElement||e instanceof ui(e).HTMLElement)}function vi(e){return!(!hi()||"undefined"==typeof ShadowRoot)&&(e instanceof ShadowRoot||e instanceof ui(e).ShadowRoot)}function yi(e){const{overflow:t,overflowX:o,overflowY:i,display:r}=Pi(e);return/auto|scroll|overlay|hidden|clip/.test(t+i+o)&&!["inline","contents"].includes(r)}function wi(e){return["table","td","th"].includes(pi(e))}function xi(e){return[":popover-open",":modal"].some((t=>{try{return e.matches(t)}catch(e){return!1}}))}function ki(e){const t=$i(),o=fi(e)?Pi(e):e;return["transform","translate","scale","rotate","perspective"].some((e=>!!o[e]&&"none"!==o[e]))||!!o.containerType&&"normal"!==o.containerType||!t&&!!o.backdropFilter&&"none"!==o.backdropFilter||!t&&!!o.filter&&"none"!==o.filter||["transform","translate","scale","rotate","perspective","filter"].some((e=>(o.willChange||"").includes(e)))||["paint","layout","strict","content"].some((e=>(o.contain||"").includes(e)))}function $i(){return!("undefined"==typeof CSS||!CSS.supports)&&CSS.supports("-webkit-backdrop-filter","none")}function _i(e){return["html","body","#document"].includes(pi(e))}function Pi(e){return ui(e).getComputedStyle(e)}function Ci(e){return fi(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function Si(e){if("html"===pi(e))return e;const t=e.assignedSlot||e.parentNode||vi(e)&&e.host||gi(e);return vi(t)?t.host:t}function Ri(e){const t=Si(e);return _i(t)?e.ownerDocument?e.ownerDocument.body:e.body:bi(t)&&yi(t)?t:Ri(t)}function Ai(e,t,o){var i;void 0===t&&(t=[]),void 0===o&&(o=!0);const r=Ri(e),s=r===(null==(i=e.ownerDocument)?void 0:i.body),a=ui(r);if(s){const e=Oi(a);return t.concat(a,a.visualViewport||[],yi(r)?r:[],e&&o?Ai(e):[])}return t.concat(r,Ai(r,[],o))}function Oi(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Ti(e){const t=Pi(e);let o=parseFloat(t.width)||0,i=parseFloat(t.height)||0;const r=bi(e),s=r?e.offsetWidth:o,a=r?e.offsetHeight:i,l=Go(o)!==s||Go(i)!==a;return l&&(o=s,i=a),{width:o,height:i,$:l}}function Di(e){return fi(e)?e:e.contextElement}function Ei(e){const t=Di(e);if(!bi(t))return Qo(1);const o=t.getBoundingClientRect(),{width:i,height:r,$:s}=Ti(t);let a=(s?Go(o.width):o.width)/i,l=(s?Go(o.height):o.height)/r;return a&&Number.isFinite(a)||(a=1),l&&Number.isFinite(l)||(l=1),{x:a,y:l}}const Li=Qo(0);function zi(e){const t=ui(e);return $i()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:Li}function Fi(e,t,o,i){void 0===t&&(t=!1),void 0===o&&(o=!1);const r=e.getBoundingClientRect(),s=Di(e);let a=Qo(1);t&&(i?fi(i)&&(a=Ei(i)):a=Ei(e));const l=function(e,t,o){return void 0===t&&(t=!1),!(!o||t&&o!==ui(e))&&t}(s,o,i)?zi(s):Qo(0);let c=(r.left+l.x)/a.x,d=(r.top+l.y)/a.y,h=r.width/a.x,p=r.height/a.y;if(s){const e=ui(s),t=i&&fi(i)?ui(i):i;let o=e,r=Oi(o);for(;r&&i&&t!==o;){const e=Ei(r),t=r.getBoundingClientRect(),i=Pi(r),s=t.left+(r.clientLeft+parseFloat(i.paddingLeft))*e.x,a=t.top+(r.clientTop+parseFloat(i.paddingTop))*e.y;c*=e.x,d*=e.y,h*=e.x,p*=e.y,c+=s,d+=a,o=ui(r),r=Oi(o)}}return li({width:h,height:p,x:c,y:d})}function Ii(e,t){const o=Ci(e).scrollLeft;return t?t.left+o:Fi(gi(e)).left+o}function Wi(e,t,o){void 0===o&&(o=!1);const i=e.getBoundingClientRect();return{x:i.left+t.scrollLeft-(o?0:Ii(e,i)),y:i.top+t.scrollTop}}function Bi(e,t,o){let i;if("viewport"===t)i=function(e,t){const o=ui(e),i=gi(e),r=o.visualViewport;let s=i.clientWidth,a=i.clientHeight,l=0,c=0;if(r){s=r.width,a=r.height;const e=$i();(!e||e&&"fixed"===t)&&(l=r.offsetLeft,c=r.offsetTop)}return{width:s,height:a,x:l,y:c}}(e,o);else if("document"===t)i=function(e){const t=gi(e),o=Ci(e),i=e.ownerDocument.body,r=Ho(t.scrollWidth,t.clientWidth,i.scrollWidth,i.clientWidth),s=Ho(t.scrollHeight,t.clientHeight,i.scrollHeight,i.clientHeight);let a=-o.scrollLeft+Ii(e);const l=-o.scrollTop;return"rtl"===Pi(i).direction&&(a+=Ho(t.clientWidth,i.clientWidth)-r),{width:r,height:s,x:a,y:l}}(gi(e));else if(fi(t))i=function(e,t){const o=Fi(e,!0,"fixed"===t),i=o.top+e.clientTop,r=o.left+e.clientLeft,s=bi(e)?Ei(e):Qo(1);return{width:e.clientWidth*s.x,height:e.clientHeight*s.y,x:r*s.x,y:i*s.y}}(t,o);else{const o=zi(e);i={x:t.x-o.x,y:t.y-o.y,width:t.width,height:t.height}}return li(i)}function Mi(e,t){const o=Si(e);return!(o===t||!fi(o)||_i(o))&&("fixed"===Pi(o).position||Mi(o,t))}function Ui(e,t,o){const i=bi(t),r=gi(t),s="fixed"===o,a=Fi(e,!0,s,t);let l={scrollLeft:0,scrollTop:0};const c=Qo(0);if(i||!i&&!s)if(("body"!==pi(t)||yi(r))&&(l=Ci(t)),i){const e=Fi(t,!0,s,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}else r&&(c.x=Ii(r));const d=!r||i||s?Qo(0):Wi(r,l);return{x:a.left+l.scrollLeft-c.x-d.x,y:a.top+l.scrollTop-c.y-d.y,width:a.width,height:a.height}}function ji(e){return"static"===Pi(e).position}function Vi(e,t){if(!bi(e)||"fixed"===Pi(e).position)return null;if(t)return t(e);let o=e.offsetParent;return gi(e)===o&&(o=o.ownerDocument.body),o}function Ni(e,t){const o=ui(e);if(xi(e))return o;if(!bi(e)){let t=Si(e);for(;t&&!_i(t);){if(fi(t)&&!ji(t))return t;t=Si(t)}return o}let i=Vi(e,t);for(;i&&wi(i)&&ji(i);)i=Vi(i,t);return i&&_i(i)&&ji(i)&&!ki(i)?o:i||function(e){let t=Si(e);for(;bi(t)&&!_i(t);){if(ki(t))return t;if(xi(t))return null;t=Si(t)}return null}(e)||o}const Hi={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:o,offsetParent:i,strategy:r}=e;const s="fixed"===r,a=gi(i),l=!!t&&xi(t.floating);if(i===a||l&&s)return o;let c={scrollLeft:0,scrollTop:0},d=Qo(1);const h=Qo(0),p=bi(i);if((p||!p&&!s)&&(("body"!==pi(i)||yi(a))&&(c=Ci(i)),bi(i))){const e=Fi(i);d=Ei(i),h.x=e.x+i.clientLeft,h.y=e.y+i.clientTop}const u=!a||p||s?Qo(0):Wi(a,c,!0);return{width:o.width*d.x,height:o.height*d.y,x:o.x*d.x-c.scrollLeft*d.x+h.x+u.x,y:o.y*d.y-c.scrollTop*d.y+h.y+u.y}},getDocumentElement:gi,getClippingRect:function(e){let{element:t,boundary:o,rootBoundary:i,strategy:r}=e;const s=[..."clippingAncestors"===o?xi(t)?[]:function(e,t){const o=t.get(e);if(o)return o;let i=Ai(e,[],!1).filter((e=>fi(e)&&"body"!==pi(e))),r=null;const s="fixed"===Pi(e).position;let a=s?Si(e):e;for(;fi(a)&&!_i(a);){const t=Pi(a),o=ki(a);o||"fixed"!==t.position||(r=null),(s?!o&&!r:!o&&"static"===t.position&&r&&["absolute","fixed"].includes(r.position)||yi(a)&&!o&&Mi(e,a))?i=i.filter((e=>e!==a)):r=t,a=Si(a)}return t.set(e,i),i}(t,this._c):[].concat(o),i],a=s[0],l=s.reduce(((e,o)=>{const i=Bi(t,o,r);return e.top=Ho(i.top,e.top),e.right=No(i.right,e.right),e.bottom=No(i.bottom,e.bottom),e.left=Ho(i.left,e.left),e}),Bi(t,a,r));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}},getOffsetParent:Ni,getElementRects:async function(e){const t=this.getOffsetParent||Ni,o=this.getDimensions,i=await o(e.floating);return{reference:Ui(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:i.width,height:i.height}}},getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){const{width:t,height:o}=Ti(e);return{width:t,height:o}},getScale:Ei,isElement:fi,isRTL:function(e){return"rtl"===Pi(e).direction}};function Gi(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function qi(e,t,o,i){void 0===i&&(i={});const{ancestorScroll:r=!0,ancestorResize:s=!0,elementResize:a="function"==typeof ResizeObserver,layoutShift:l="function"==typeof IntersectionObserver,animationFrame:c=!1}=i,d=Di(e),h=r||s?[...d?Ai(d):[],...Ai(t)]:[];h.forEach((e=>{r&&e.addEventListener("scroll",o,{passive:!0}),s&&e.addEventListener("resize",o)}));const p=d&&l?function(e,t){let o,i=null;const r=gi(e);function s(){var e;clearTimeout(o),null==(e=i)||e.disconnect(),i=null}return function a(l,c){void 0===l&&(l=!1),void 0===c&&(c=1),s();const d=e.getBoundingClientRect(),{left:h,top:p,width:u,height:g}=d;if(l||t(),!u||!g)return;const m={rootMargin:-qo(p)+"px "+-qo(r.clientWidth-(h+u))+"px "+-qo(r.clientHeight-(p+g))+"px "+-qo(h)+"px",threshold:Ho(0,No(1,c))||1};let f=!0;function v(t){const i=t[0].intersectionRatio;if(i!==c){if(!f)return a();i?a(!1,i):o=setTimeout((()=>{a(!1,1e-7)}),1e3)}1!==i||Gi(d,e.getBoundingClientRect())||a(),f=!1}try{i=new IntersectionObserver(v,{...m,root:r.ownerDocument})}catch(e){i=new IntersectionObserver(v,m)}i.observe(e)}(!0),s}(d,o):null;let u,g=-1,m=null;a&&(m=new ResizeObserver((e=>{let[i]=e;i&&i.target===d&&m&&(m.unobserve(t),cancelAnimationFrame(g),g=requestAnimationFrame((()=>{var e;null==(e=m)||e.observe(t)}))),o()})),d&&!c&&m.observe(d),m.observe(t));let f=c?Fi(e):null;return c&&function t(){const i=Fi(e);f&&!Gi(f,i)&&o();f=i,u=requestAnimationFrame(t)}(),o(),()=>{var e;h.forEach((e=>{r&&e.removeEventListener("scroll",o),s&&e.removeEventListener("resize",o)})),null==p||p(),null==(e=m)||e.disconnect(),m=null,c&&cancelAnimationFrame(u)}}const Qi=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var o,i;const{x:r,y:s,placement:a,middlewareData:l}=t,c=await async function(e,t){const{placement:o,platform:i,elements:r}=e,s=await(null==i.isRTL?void 0:i.isRTL(r.floating)),a=Xo(o),l=ei(o),c="y"===ii(o),d=["left","top"].includes(a)?-1:1,h=s&&c?-1:1,p=Zo(t,e);let{mainAxis:u,crossAxis:g,alignmentAxis:m}="number"==typeof p?{mainAxis:p,crossAxis:0,alignmentAxis:null}:{mainAxis:p.mainAxis||0,crossAxis:p.crossAxis||0,alignmentAxis:p.alignmentAxis};return l&&"number"==typeof m&&(g="end"===l?-1*m:m),c?{x:g*h,y:u*d}:{x:u*d,y:g*h}}(t,e);return a===(null==(o=l.offset)?void 0:o.placement)&&null!=(i=l.arrow)&&i.alignmentOffset?{}:{x:r+c.x,y:s+c.y,data:{...c,placement:a}}}}},Yi=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:o,y:i,placement:r}=t,{mainAxis:s=!0,crossAxis:a=!1,limiter:l={fn:e=>{let{x:t,y:o}=e;return{x:t,y:o}}},...c}=Zo(e,t),d={x:o,y:i},h=await di(t,c),p=ii(Xo(r)),u=ti(p);let g=d[u],m=d[p];if(s){const e="y"===u?"bottom":"right";g=Jo(g+h["y"===u?"top":"left"],g,g-h[e])}if(a){const e="y"===p?"bottom":"right";m=Jo(m+h["y"===p?"top":"left"],m,m-h[e])}const f=l.fn({...t,[u]:g,[p]:m});return{...f,data:{x:f.x-o,y:f.y-i,enabled:{[u]:s,[p]:a}}}}}},Ki=function(e){return void 0===e&&(e={}),{name:"flip",options:e,async fn(t){var o,i;const{placement:r,middlewareData:s,rects:a,initialPlacement:l,platform:c,elements:d}=t,{mainAxis:h=!0,crossAxis:p=!0,fallbackPlacements:u,fallbackStrategy:g="bestFit",fallbackAxisSideDirection:m="none",flipAlignment:f=!0,...v}=Zo(e,t);if(null!=(o=s.arrow)&&o.alignmentOffset)return{};const y=Xo(r),w=ii(l),x=Xo(l)===l,$=await(null==c.isRTL?void 0:c.isRTL(d.floating)),_=u||(x||!f?[si(l)]:function(e){const t=si(e);return[ni(e),t,ni(t)]}(l)),P="none"!==m;!u&&P&&_.push(...function(e,t,o,i){const r=ei(e);let s=function(e,t,o){const i=["left","right"],r=["right","left"],s=["top","bottom"],a=["bottom","top"];switch(e){case"top":case"bottom":return o?t?r:i:t?i:r;case"left":case"right":return t?s:a;default:return[]}}(Xo(e),"start"===o,i);return r&&(s=s.map((e=>e+"-"+r)),t&&(s=s.concat(s.map(ni)))),s}(l,f,m,$));const C=[l,..._],S=await di(t,v),A=[];let O=(null==(i=s.flip)?void 0:i.overflows)||[];if(h&&A.push(S[y]),p){const e=function(e,t,o){void 0===o&&(o=!1);const i=ei(e),r=ri(e),s=oi(r);let a="x"===r?i===(o?"end":"start")?"right":"left":"start"===i?"bottom":"top";return t.reference[s]>t.floating[s]&&(a=si(a)),[a,si(a)]}(r,a,$);A.push(S[e[0]],S[e[1]])}if(O=[...O,{placement:r,overflows:A}],!A.every((e=>e<=0))){var T,D;const e=((null==(T=s.flip)?void 0:T.index)||0)+1,t=C[e];if(t)return{data:{index:e,overflows:O},reset:{placement:t}};let o=null==(D=O.filter((e=>e.overflows[0]<=0)).sort(((e,t)=>e.overflows[1]-t.overflows[1]))[0])?void 0:D.placement;if(!o)switch(g){case"bestFit":{var E;const e=null==(E=O.filter((e=>{if(P){const t=ii(e.placement);return t===w||"y"===t}return!0})).map((e=>[e.placement,e.overflows.filter((e=>e>0)).reduce(((e,t)=>e+t),0)])).sort(((e,t)=>e[1]-t[1]))[0])?void 0:E[0];e&&(o=e);break}case"initialPlacement":o=l}if(r!==o)return{reset:{placement:o}}}return{}}}},Ji=function(e){return void 0===e&&(e={}),{name:"size",options:e,async fn(t){var o,i;const{placement:r,rects:s,platform:a,elements:l}=t,{apply:c=()=>{},...d}=Zo(e,t),h=await di(t,d),p=Xo(r),u=ei(r),g="y"===ii(r),{width:m,height:f}=s.floating;let v,y;"top"===p||"bottom"===p?(v=p,y=u===(await(null==a.isRTL?void 0:a.isRTL(l.floating))?"start":"end")?"left":"right"):(y=p,v="end"===u?"top":"bottom");const w=f-h.top-h.bottom,x=m-h.left-h.right,$=No(f-h[v],w),_=No(m-h[y],x),P=!t.middlewareData.shift;let C=$,S=_;if(null!=(o=t.middlewareData.shift)&&o.enabled.x&&(S=x),null!=(i=t.middlewareData.shift)&&i.enabled.y&&(C=w),P&&!u){const e=Ho(h.left,0),t=Ho(h.right,0),o=Ho(h.top,0),i=Ho(h.bottom,0);g?S=m-2*(0!==e||0!==t?e+t:Ho(h.left,h.right)):C=f-2*(0!==o||0!==i?o+i:Ho(h.top,h.bottom))}await c({...t,availableWidth:S,availableHeight:C});const A=await a.getDimensions(l.floating);return m!==A.width||f!==A.height?{reset:{rects:!0}}:{}}}},Zi=e=>({name:"arrow",options:e,async fn(t){const{x:o,y:i,placement:r,rects:s,platform:a,elements:l,middlewareData:c}=t,{element:d,padding:h=0}=Zo(e,t)||{};if(null==d)return{};const p=ai(h),u={x:o,y:i},g=ri(r),m=oi(g),f=await a.getDimensions(d),v="y"===g,y=v?"top":"left",w=v?"bottom":"right",x=v?"clientHeight":"clientWidth",$=s.reference[m]+s.reference[g]-u[g]-s.floating[m],_=u[g]-s.reference[g],P=await(null==a.getOffsetParent?void 0:a.getOffsetParent(d));let C=P?P[x]:0;C&&await(null==a.isElement?void 0:a.isElement(P))||(C=l.floating[x]||s.floating[m]);const S=$/2-_/2,A=C/2-f[m]/2-1,O=No(p[y],A),T=No(p[w],A),D=O,E=C-f[m]-T,F=C/2-f[m]/2+S,W=Jo(D,F,E),B=!c.arrow&&null!=ei(r)&&F!==W&&s.reference[m]/2-(F<D?O:T)-f[m]/2<0,U=B?F<D?F-D:F-E:0;return{[g]:u[g]+U,data:{[g]:W,centerOffset:F-W-U,...B&&{alignmentOffset:U}},reset:B}}}),Xi=(e,t,o)=>{const i=new Map,r={platform:Hi,...o},s={...r.platform,_c:i};return(async(e,t,o)=>{const{placement:i="bottom",strategy:r="absolute",middleware:s=[],platform:a}=o,l=s.filter(Boolean),c=await(null==a.isRTL?void 0:a.isRTL(t));let d=await a.getElementRects({reference:e,floating:t,strategy:r}),{x:h,y:p}=ci(d,i,c),u=i,g={},m=0;for(let o=0;o<l.length;o++){const{name:s,fn:f}=l[o],{x:v,y,data:w,reset:x}=await f({x:h,y:p,initialPlacement:i,placement:u,strategy:r,middlewareData:g,rects:d,platform:a,elements:{reference:e,floating:t}});h=null!=v?v:h,p=null!=y?y:p,g={...g,[s]:{...g[s],...w}},x&&m<=50&&(m++,"object"==typeof x&&(x.placement&&(u=x.placement),x.rects&&(d=!0===x.rects?await a.getElementRects({reference:e,floating:t,strategy:r}):x.rects),({x:h,y:p}=ci(d,u,c))),o=-1)}return{x:h,y:p,placement:u,strategy:r,middlewareData:g}})(e,t,{...r,platform:s})},er=1;class directive_i{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,o){this._$Ct=e,this._$AM=t,this._$Ci=o}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const tr=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends directive_i{constructor(e){if(super(e),e.type!==er||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){if(void 0===this.st){this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}const o=e.element.classList;for(const e of this.st)e in t||(o.remove(e),this.st.delete(e));for(const e in t){const i=!!t[e];i===this.st.has(e)||this.nt?.has(e)||(i?(o.add(e),this.st.add(e)):(o.remove(e),this.st.delete(e)))}return ne}});function or(e){return rr(e)}function ir(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function rr(e){for(let t=e;t;t=ir(t))if(t instanceof Element&&"none"===getComputedStyle(t).display)return null;for(let t=ir(e);t;t=ir(t)){if(!(t instanceof Element))continue;const e=getComputedStyle(t);if("contents"!==e.display){if("static"!==e.position||ki(e))return t;if("BODY"===t.tagName)return t}}return null}var nr=class extends Vo{constructor(){super(...arguments),this.localize=new Mo(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect();let o=0,i=0,r=0,s=0,a=0,l=0,c=0,d=0;this.placement.includes("top")||this.placement.includes("bottom")?e.top<t.top?(o=e.left,i=e.bottom,r=e.right,s=e.bottom,a=t.left,l=t.top,c=t.right,d=t.top):(o=t.left,i=t.bottom,r=t.right,s=t.bottom,a=e.left,l=e.top,c=e.right,d=e.top):e.left<t.left?(o=e.right,i=e.top,r=t.left,s=t.top,a=e.right,l=e.bottom,c=t.left,d=t.bottom):(o=t.right,i=t.top,r=e.left,s=e.top,a=t.right,l=t.bottom,c=e.left,d=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${o}px`),this.style.setProperty("--hover-bridge-top-left-y",`${i}px`),this.style.setProperty("--hover-bridge-top-right-x",`${r}px`),this.style.setProperty("--hover-bridge-top-right-y",`${s}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${a}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${d}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&"string"==typeof this.anchor){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||function(e){return null!==e&&"object"==typeof e&&"getBoundingClientRect"in e&&(!("contextElement"in e)||e instanceof Element)}(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){this.anchorEl&&this.active&&(this.cleanup=qi(this.anchorEl,this.popup,(()=>{this.reposition()})))}async stop(){return new Promise((e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame((()=>e()))):e()}))}reposition(){if(!this.active||!this.anchorEl)return;const e=[Qi({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(Ji({apply:({rects:e})=>{const t="width"===this.sync||"both"===this.sync,o="height"===this.sync||"both"===this.sync;this.popup.style.width=t?`${e.reference.width}px`:"",this.popup.style.height=o?`${e.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(Ki({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:"best-fit"===this.flipFallbackStrategy?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(Yi({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(Ji({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:e,availableHeight:t})=>{"vertical"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-height",`${t}px`):this.style.removeProperty("--auto-size-available-height"),"horizontal"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-width",`${e}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(Zi({element:this.arrowEl,padding:this.arrowPadding}));const t="absolute"===this.strategy?e=>Hi.getOffsetParent(e,or):Hi.getOffsetParent;Xi(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:yo(vo({},Hi),{getOffsetParent:t})}).then((({x:e,y:t,middlewareData:o,placement:i})=>{const r="rtl"===this.localize.dir(),s={top:"bottom",right:"left",bottom:"top",left:"right"}[i.split("-")[0]];if(this.setAttribute("data-current-placement",i),Object.assign(this.popup.style,{left:`${e}px`,top:`${t}px`}),this.arrow){const e=o.arrow.x,t=o.arrow.y;let i="",a="",l="",c="";if("start"===this.arrowPlacement){const o="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";i="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",a=r?o:"",c=r?"":o}else if("end"===this.arrowPlacement){const o="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";a=r?"":o,c=r?o:"",l="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else"center"===this.arrowPlacement?(c="number"==typeof e?"calc(50% - var(--arrow-size-diagonal))":"",i="number"==typeof t?"calc(50% - var(--arrow-size-diagonal))":""):(c="number"==typeof e?`${e}px`:"",i="number"==typeof t?`${t}px`:"");Object.assign(this.arrowEl.style,{top:i,right:a,bottom:l,left:c,[s]:"calc(var(--arrow-size-diagonal) * -1)"})}})),requestAnimationFrame((()=>this.updateHoverBridge())),this.emit("sl-reposition")}render(){return re`
    ...
    `}};function sr(e,t){return new Promise((o=>{e.addEventListener(t,(function i(r){r.target===e&&(e.removeEventListener(t,i),o())}))}))}function ar(e,t,o){return new Promise((i=>{if((null==o?void 0:o.duration)===1/0)throw new Error("Promise-based animations must be finite.");const r=e.animate(t,yo(vo({},o),{duration:cr()?0:o.duration}));r.addEventListener("cancel",i,{once:!0}),r.addEventListener("finish",i,{once:!0})}))}function lr(e){return(e=e.toString().toLowerCase()).indexOf("ms")>-1?parseFloat(e):e.indexOf("s")>-1?1e3*parseFloat(e):parseFloat(e)}function cr(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function dr(e){return Promise.all(e.getAnimations().map((e=>new Promise((t=>{e.cancel(),requestAnimationFrame(t)})))))}function hr(e,t){const o=vo({waitUntilFirstUpdate:!1},t);return(t,i)=>{const{update:r}=t,s=Array.isArray(e)?e:[e];t.update=function(e){s.forEach((t=>{const r=t;if(e.has(r)){const t=e.get(r),s=this[r];t!==s&&(o.waitUntilFirstUpdate&&!this.hasUpdated||this[i](t,s))}})),r.call(this,e)}}}nr.styles=[jo,Ao],wo([we(".popup")],nr.prototype,"popup",2),wo([we(".popup__arrow")],nr.prototype,"arrowEl",2),wo([be()],nr.prototype,"anchor",2),wo([be({type:Boolean,reflect:!0})],nr.prototype,"active",2),wo([be({reflect:!0})],nr.prototype,"placement",2),wo([be({reflect:!0})],nr.prototype,"strategy",2),wo([be({type:Number})],nr.prototype,"distance",2),wo([be({type:Number})],nr.prototype,"skidding",2),wo([be({type:Boolean})],nr.prototype,"arrow",2),wo([be({attribute:"arrow-placement"})],nr.prototype,"arrowPlacement",2),wo([be({attribute:"arrow-padding",type:Number})],nr.prototype,"arrowPadding",2),wo([be({type:Boolean})],nr.prototype,"flip",2),wo([be({attribute:"flip-fallback-placements",converter:{fromAttribute:e=>e.split(" ").map((e=>e.trim())).filter((e=>""!==e)),toAttribute:e=>e.join(" ")}})],nr.prototype,"flipFallbackPlacements",2),wo([be({attribute:"flip-fallback-strategy"})],nr.prototype,"flipFallbackStrategy",2),wo([be({type:Object})],nr.prototype,"flipBoundary",2),wo([be({attribute:"flip-padding",type:Number})],nr.prototype,"flipPadding",2),wo([be({type:Boolean})],nr.prototype,"shift",2),wo([be({type:Object})],nr.prototype,"shiftBoundary",2),wo([be({attribute:"shift-padding",type:Number})],nr.prototype,"shiftPadding",2),wo([be({attribute:"auto-size"})],nr.prototype,"autoSize",2),wo([be()],nr.prototype,"sync",2),wo([be({type:Object})],nr.prototype,"autoSizeBoundary",2),wo([be({attribute:"auto-size-padding",type:Number})],nr.prototype,"autoSizePadding",2),wo([be({attribute:"hover-bridge",type:Boolean})],nr.prototype,"hoverBridge",2);var pr=class extends Vo{constructor(){super(),this.localize=new Mo(this),this.content="",this.placement="top",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{"Escape"===e.key&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){const e=lr(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout((()=>this.show()),e)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){const e=lr(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout((()=>this.hide()),e)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}disconnectedCallback(){var e;super.disconnectedCallback(),null==(e=this.closeWatcher)||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(" ").includes(e)}async handleOpenChange(){var e,t;if(this.open){if(this.disabled)return;this.emit("sl-show"),"CloseWatcher"in window?(null==(e=this.closeWatcher)||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await dr(this.body),this.body.hidden=!1,this.popup.active=!0;const{keyframes:t,options:o}=So(this,"tooltip.show",{dir:this.localize.dir()});await ar(this.popup.popup,t,o),this.popup.reposition(),this.emit("sl-after-show")}else{this.emit("sl-hide"),null==(t=this.closeWatcher)||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await dr(this.body);const{keyframes:e,options:o}=So(this,"tooltip.hide",{dir:this.localize.dir()});await ar(this.popup.popup,e,o),this.popup.active=!1,this.body.hidden=!0,this.emit("sl-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,sr(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,sr(this,"sl-after-hide")}render(){return re`
      <sl-popup
        part="base"
        exportparts="
          popup:base__popup,
    ...
    `}};pr.styles=[jo,Ro],pr.dependencies={"sl-popup":nr},wo([we("slot:not([name])")],pr.prototype,"defaultSlot",2),wo([we(".tooltip__body")],pr.prototype,"body",2),wo([we("sl-popup")],pr.prototype,"popup",2),wo([be()],pr.prototype,"content",2),wo([be()],pr.prototype,"placement",2),wo([be({type:Boolean,reflect:!0})],pr.prototype,"disabled",2),wo([be({type:Number})],pr.prototype,"distance",2),wo([be({type:Boolean,reflect:!0})],pr.prototype,"open",2),wo([be({type:Number})],pr.prototype,"skidding",2),wo([be()],pr.prototype,"trigger",2),wo([be({type:Boolean})],pr.prototype,"hoist",2),wo([hr("open",{waitUntilFirstUpdate:!0})],pr.prototype,"handleOpenChange",1),wo([hr(["content","distance","hoist","placement","skidding"])],pr.prototype,"handleOptionsChange",1),wo([hr("disabled")],pr.prototype,"handleDisabledChange",1),Co("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}}),Co("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});pr.define("sl-tooltip");var ur=Object.defineProperty,gr=Object.getOwnPropertyDescriptor,mr=(e,t,o,i)=>{for(var r,s=i>1?void 0:i?gr(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(i?r(t,o,s):r(s))||s);return i&&s&&ur(t,o,s),s};Co("tooltip.show",null),Co("tooltip.hide",null);let fr=class extends lit_element_r{constructor(){super(...arguments),this.placement="bottom",this.disabled=!1}firstUpdated(){this.observer=new MutationObserver((e=>{for(const t of e)if("attributes"===t.type&&"data-current-placement"===t.attributeName){const e=t.target.getAttribute("data-current-placement");e?this.setAttribute("data-current-placement",e):this.removeAttribute("data-current-placement")}}));const e=this.shadowRoot?.querySelector("sl-tooltip")?.shadowRoot;e&&this.observer.observe(e,{attributes:!0,attributeFilter:["data-current-placement"],subtree:!0})}disconnectedCallback(){this.observer?.disconnect()}render(){return re`<sl-tooltip
			.placement=${this.placement}
	...
	`,mr([be()],fr.prototype,"content",2),mr([be({reflect:!0})],fr.prototype,"placement",2),mr([be({type:Boolean})],fr.prototype,"disabled",2),mr([be({type:Number})],fr.prototype,"distance",2),mr([be({type:Boolean})],fr.prototype,"hoist",2),fr=mr([ge("gl-tooltip")],fr);var br=Object.defineProperty,vr=Object.getOwnPropertyDescriptor,yr=(e,t,o,i)=>{for(var r,s=i>1?void 0:i?vr(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(i?r(t,o,s):r(s))||s);return i&&s&&br(t,o,s),s};let wr=class extends lit_element_r{constructor(){super(...arguments),this.disabled=!1,this.full=!1,this.tooltipPlacement="bottom"}get role(){return this.href?"link":"button"}updated(e){super.updated(e),e.has("disabled")&&this.setAttribute("aria-disabled",this.disabled.toString())}render(){return this.tooltip?re`<gl-tooltip .content=${this.tooltip} placement=${io(this.tooltipPlacement)}
				>${this.renderControl()}</gl-tooltip
			>`:this.querySelectorAll('[slot="tooltip"]').length>0?re`<gl-tooltip placement=${io(this.tooltipPlacement)}>
				${this.renderControl()}
			...
			class="control"
			role=${io(this.role)}
			aria-checked=${io(this.ariaChecked)}
			?disabled=${this.disabled}
		>
			<slot name="prefix"></slot><slot class="label"></slot><slot name="suffix"></slot>
		</button>`}onLinkKeypress(e){" "===e.key&&this.control.click()}focus(e){this.control.focus(e)}blur(){this.control.blur()}click(){this.control.click()}};wr.shadowRootOptions={...lit_element_r.shadowRootOptions,delegatesFocus:!0},wr.styles=[so,p`
			:host {
		...
		`],yr([we(".control")],wr.prototype,"control",2),yr([be({reflect:!0})],wr.prototype,"appearance",2),yr([be({type:Boolean,reflect:!0})],wr.prototype,"disabled",2),yr([be({reflect:!0})],wr.prototype,"density",2),yr([be({type:Boolean,reflect:!0})],wr.prototype,"full",2),yr([be()],wr.prototype,"href",2),yr([be({reflect:!0})],wr.prototype,"role",1),yr([be()],wr.prototype,"tooltip",2),yr([be()],wr.prototype,"tooltipPlacement",2),wr=yr([ge("gl-button")],wr);var xr=Object.defineProperty,kr=Object.getOwnPropertyDescriptor,$r=(e,t,o,i)=>{for(var r,s=i>1?void 0:i?kr(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(i?r(t,o,s):r(s))||s);return i&&s&&xr(t,o,s),s};let _r=class extends lit_element_r{constructor(){super(...arguments),this.type="info"}get hasPromo(){return null!=this.promo}render(){if(!this.promo)return;const e=this.renderPromo(this.promo);return e?"link"===this.type?re`<a
				class="link"
				href="${this.promo.command?.command??"command:gitlens.plus.upgrade"}"
				title="${io(this.promo.command?.tooltip)}"
				>${e}</a
			>`:re`<p class="promo">${e}</p>`:void 0}renderPromo(e){switch(e.key){case"gkholiday":return re`<span class="content${"link"===this.type?se:" muted"}"
					>Get the gift of a better DevEx in 2025! <b>Save up to 80% now</b></span
				>`;case"pro50":return re`<span class="content${"link"===this.type?se:" muted"}"
					><b>Save 33% or more</b> on your 1st seat of Pro</span
				>`;default:return e.key,se}}};_r.styles=[p`
			:host {
				display: block;
			}
		...
		`],$r([be({type:Object})],_r.prototype,"promo",2),$r([be({reflect:!0,type:String})],_r.prototype,"type",2),$r([be({reflect:!0,type:Boolean,attribute:"has-promo"})],_r.prototype,"hasPromo",1),_r=$r([ge("gl-promo")],_r);var Pr=Object.defineProperty,Cr=Object.getOwnPropertyDescriptor,Sr=(e,t,o,i)=>{for(var r,s=i>1?void 0:i?Cr(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(i?r(t,o,s):r(s))||s);return i&&s&&Pr(t,o,s),s};let Rr=class extends lit_element_r{firstUpdated(){"alert"===this.appearance&&queueMicrotask((()=>this.button.focus()))}render(){if(null==this.state)return void(this.hidden=!0);this.hidden=!1;const e="alert"===(this.appearance??"alert")?"alert":se,t=this.state?eo(this.state,"gate"):void 0;switch(this.state){case $e.VerificationRequired:return re`
					<slot name="feature"></slot>
					<p class="actions">
						<gl-button
							class="inline"
							appearance="${e}"
							href="${Ar(Zt.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							class="inline"
							appearance="${e}"
							href="${Ar(Zt.PlusValidate,this.source)}"
				...
				`;case $e.Community:case $e.ProPreviewExpired:return this.featurePreview&&"expired"!==function(e){const t=e?.usages;if(!t?.length)return"eligible";const o=(new Date(t[t.length-1].expiresOn).getTime()-(new Date).getTime())/36e5;return t.length<=3&&o>0&&o<24?"active":"expired"}(this.featurePreview)?re`${this.renderFeaturePreview(this.featurePreview)}`:re`<slot name="feature"></slot>
					...
					<p class="actions-row">
						<gl-button
							class="inline"
							appearance="${e}"
							href="${Ar(Zt.PlusSignUp,this.source)}"
							>&nbsp;Try GitLens Pro&nbsp;</gl-button
						><span
							>or
							<a href="${Ar(Zt.PlusLogin,this.source)}" title="Sign In"
								>sign in</a
							></span
						>
					</p>
					...
					</p>`;case $e.ProTrialExpired:return re`<slot name="feature"></slot>
					<p>Use on privately-hosted repos requires <a href="${ut.communityVsPro}">GitLens Pro</a>.</p>
					<p class="actions-row">
						<gl-button
							class="inline"
							appearance="${e}"
							href="${Ar(Zt.PlusUpgrade,this.source)}"
					...
					<p>${this.renderPromo(t)}</p>`;case $e.ProTrialReactivationEligible:return re`<slot name="feature"></slot>
					<p class="actions-row">
						<gl-button
							class="inline"
							appearance="${e}"
							href="${Ar(Zt.PlusReactivateProTrial,this.source)}"
							>Continue</gl-button
						><span
							>or
							<a href="${Ar(Zt.PlusLogin,this.source)}" title="Sign In"
				...
				<p>
					...
					repos, or
					<a href="${Ar(Zt.PlusLogin,this.source)}" title="Sign In">sign in</a
					>.<br />
					${"alert"!==t?re`<br />`:""} For full access to all GitLens Pro features,
					<a href="${Ar(Zt.PlusSignUp,this.source)}"
			...
			<p class="actions-row">
				...
				><span
					>or
					<a href="${Ar(Zt.PlusLogin,this.source)}" title="Sign In">sign in</a></span
				>
			</p>
			<p>
		...
		`}renderFeaturePreviewStep(e,t){if("graph"===e.feature)switch(t){case 1:return re`<p>Try Commit Search</p>
						...
						`;default:return re`<slot name="feature"></slot>`}return re`<slot name="feature"></slot>`}renderPromo(e){return re`<gl-promo .promo=${e}></gl-promo>`}};function Ar(e,t){return`command:${e}${t?`?${encodeURIComponent(JSON.stringify(t))}`:""}`}Rr.styles=[oo,p`
			:host {
		...
		`],Sr([we("gl-button")],Rr.prototype,"button",2),Sr([be({type:Object})],Rr.prototype,"featurePreview",2),Sr([be({type:String})],Rr.prototype,"featurePreviewCommandLink",2),Sr([be({type:String})],Rr.prototype,"appearance",2),Sr([be()],Rr.prototype,"featureWithArticleIfNeeded",2),Sr([be({type:Object})],Rr.prototype,"source",2),Sr([be({attribute:!1,type:Number})],Rr.prototype,"state",2),Sr([be({type:String})],Rr.prototype,"webroot",2),Rr=Sr([ge("gl-feature-gate-plus-state")],Rr);var Or=Object.defineProperty,Tr=Object.getOwnPropertyDescriptor,Dr=(e,t,o,i)=>{for(var r,s=i>1?void 0:i?Tr(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(i?r(t,o,s):r(s))||s);return i&&s&&Or(t,o,s),s};let Er=class extends lit_element_r{render(){if(!this.visible||null!=this.state&&(null!=(e=this.state)&&(e===$e.Paid||e===$e.ProPreview||e===$e.ProTrial)))return void(this.hidden=!0);var e;const t=this.appearance??"editor"===(document.body.getAttribute("data-placement")??"editor")?"alert":"welcome";return this.hidden=!1,re`
			<section>
				<slot></slot>
	...
	`,Fr([we("#popover")],Ir.prototype,"body",2),Fr([we("sl-popup")],Ir.prototype,"popup",2),Fr([be({reflect:!0})],Ir.prototype,"placement",2),Fr([be({type:Object})],Ir.prototype,"anchor",2),Fr([be({reflect:!0,type:Boolean})],Ir.prototype,"disabled",2),Fr([be({type:Number})],Ir.prototype,"distance",2),Fr([be({reflect:!0,type:Boolean})],Ir.prototype,"open",2),Fr([be({reflect:!0,type:Boolean})],Ir.prototype,"arrow",2),Fr([be({type:Number})],Ir.prototype,"skidding",2),Fr([be()],Ir.prototype,"trigger",2),Fr([be({type:Boolean})],Ir.prototype,"hoist",2),Fr([it("open",{afterFirstUpdate:!0})],Ir.prototype,"handleOpenChange",1),Fr([it(["distance","hoist","placement","skidding"])],Ir.prototype,"handleOptionsChange",1),Fr([it("disabled")],Ir.prototype,"handleDisabledChange",1),Ir=Fr([ge("gl-popover")],Ir);var Wr=Object.defineProperty,Br=Object.getOwnPropertyDescriptor,Mr=(e,t,o,i)=>{for(var r,s=i>1?void 0:i?Br(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(i?r(t,o,s):r(s))||s);return i&&s&&Wr(t,o,s),s};let Ur=class extends lit_element_r{constructor(){super(...arguments),this.cloud=!1,this.placement="bottom",this.preview=!1}get daysRemaining(){return null==this.subscription?0:We(this.subscription,"days")??0}get state(){return this.subscription?.state}render(){return re`
		...
		`}renderBadge(){const e=this.preview?"Preview":"Pro";if(null!=this.subscription){if(this.state===$e.VerificationRequired)return re`${e} <code-icon class="badge-icon" icon="warning" size="10"></code-icon>`;if(Me(this.subscription)||this.cloud&&null!=this.subscription.account)return re`${e} <code-icon class="badge-icon" icon="check" size="10"></code-icon>`;if(null!=(t=this.state)&&(t===$e.ProPreview||t===$e.ProTrial))return re`${e} <code-icon class="badge-icon" icon="clock" size="10"></code-icon>`}var t;return e}renderPopoverHeader(){const e=re`<span class="popup-title">${this.preview?"Preview feature":"Pro feature"}</span>`;return this.state===$e.Paid?re`<div class="popup-header">${e}</div>`:this.cloud?this.preview?re`<div class="popup-header">
			...
			${e}<span class="popup-subtitle"> Requires GitLens Pro for use on privately-hosted repos</span>
		</div>`}renderPopoverContent(){if(null==this.subscription)return se;let e;switch(this.state){case $e.Paid:e=re`<p>
					Your
					<gl-tooltip hoist content="Show Account view">
						<a href="${jr(Zt.ShowAccountView,void 0)}"
							>${Ie(this.subscription?.plan.actual.id??ke.Pro)}</a
						>
					</gl-tooltip>
					plan provides access to all Pro features.
				</p>`;break;case $e.VerificationRequired:e=re`<p>You must verify your email before you can access Pro features.</p>
					<div class="actions">
						<gl-button
							appearance="primary"
							density="tight"
							href="${jr(Zt.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							appearance="secondary"
							density="tight"
							href="${jr(Zt.PlusValidate,this.source)}"
							><code-icon icon="refresh"></code-icon
						></gl-button>
					</div>`;break;case $e.ProTrial:{const t=this.daysRemaining;e=re`<p>
						You have
						<strong>${t<1?"<1 day":bt("day",t,{infix:" more "})} left</strong>
						in your Pro trial. Once your trial ends, you will only be able to use Pro features on
						publicly-hosted repos.
					</p>
					${this.renderUpgradeActions()}`;break}case $e.ProTrialExpired:e=re`<p>
						Your Pro trial has ended. You can now only use Pro features on publicly-hosted repos.
					</p>
					${this.renderUpgradeActions(re`<p>Please upgrade for full access to all GitLens Pro features:</p>`)}`;break;case $e.ProTrialReactivationEligible:e=re`<p>
					...
					<div class="actions center">
						<gl-button
							appearance="primary"
							density="tight"
							href="${jr(Zt.PlusReactivateProTrial,this.source)}"
							tooltip="Reactivate your Pro trial for another ${bt("day",xe)}"
							>Reactivate Pro Trial</gl-button
						>
					</div>`;break;default:if(!this.cloud&&this.state===$e.ProPreview){const t=this.daysRemaining;e=re`<p>
							You have
							<strong>${t<1?"<1 day":bt("day",t,{infix:" more "})} left</strong>
							to preview
			...
			<gl-button
				appearance="primary"
				density="tight"
				href="${jr(Zt.PlusSignUp,this.source)}"
				>Start ${xe}-day Pro Trial</gl-button
			>
			&nbsp;or <a href="${jr(Zt.PlusLogin,this.source)}" title="Sign In">sign in</a>
		</div>`}renderUpgradeActions(e){const t=eo(this.state,"badge");return re`<div class="actions">
			${e??se}
			<gl-button
				appearance="primary"
				density="tight"
				href="${jr(Zt.PlusUpgrade,this.source)}"
				>Upgrade to Pro</gl-button
			>
			${this.renderPromo(t)}
		</div>`}renderPromo(e){return re`<gl-promo .promo=${e}></gl-promo>`}};function jr(e,t){return`command:${e}${t?`?${encodeURIComponent(JSON.stringify(t))}`:""}`}Ur.styles=[so,ao,p`
			:host {
				/* position: relative; */
				display: inline-block;
	...
	`,qr([be({reflect:!0})],Yr.prototype,"icon",2),qr([be({reflect:!0})],Yr.prototype,"modifier",2),qr([be({type:Number})],Yr.prototype,"size",2),qr([be({reflect:!0})],Yr.prototype,"flip",2),qr([be({reflect:!0})],Yr.prototype,"rotate",2),Yr=qr([ge("code-icon")],Yr);var Kr=Object.defineProperty,Jr=Object.getOwnPropertyDescriptor,Zr=(e,t,o,i)=>{for(var r,s=i>1?void 0:i?Jr(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(i?r(t,o,s):r(s))||s);return i&&s&&Kr(t,o,s),s};let Xr=class extends lit_element_r{constructor(){super(...arguments),this.mode="infinite",this.active=!1,this.position="bottom"}firstUpdated(){this.setAttribute("role","progressbar")}render(){return re`<div class="progress-bar"></div>`}};Xr.styles=p`
		* {
			box-sizing: border-box;
		}
	...
	`,Zr([be({reflect:!0})],Xr.prototype,"mode",2),Zr([be({type:Boolean})],Xr.prototype,"active",2),Zr([be()],Xr.prototype,"position",2),Xr=Zr([ge("progress-indicator")],Xr);var en=Object.defineProperty,tn=Object.getOwnPropertyDescriptor,on=(e,t,o,i)=>{for(var r,s=i>1?void 0:i?tn(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(i?r(t,o,s):r(s))||s);return i&&s&&en(t,o,s),s};let rn=class extends GlApp{constructor(){super(...arguments),this._loading=!0,this._zoomed=!1,this.onDocumentKeyDown=e=>{"Escape"!==e.key&&"Esc"!==e.key||this._chart?.reset()}}createStateProvider(e,t){return new TimelineStateProvider(this,e,t)}onPersistState(e){this._ipc.setState({period:e.period,uri:e.uri})}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.onDocumentKeyDown)}disconnectedCallback(){document.removeEventListener("keydown",this.onDocumentKeyDown),super.disconnectedCallback()}get allowed(){return this.state.access?.allowed??!1}get header(){let e,t=this.state.title;if(null!=t){const o=t.lastIndexOf("/");if(o>=0){const i=t.substring(o+1);e=t.substring(0,o),t=i}}return{title:t??"",description:e??""}}get loading(){return null!=this.state.dataset&&null!=this.uri&&this._loading}get period(){return this.state.period}get subscription(){return this.state.access?.subscription?.current}get sha(){return this.state.sha}get uri(){return this.state.uri}get uriType(){return this.state.uriType}get zoomed(){return this._zoomed}willUpdate(e){e.has("_loading")||e.has("_zoomed")||(this._loading=Boolean(this.state.dataset&&this.uri)),super.willUpdate(e)}render(){return re`
			...
			<div class="container">
				...
				<header class="header" ?hidden=${!this.uri}>
					...
					<span class="toolbox">
						...
						${null!=this.subscription&&Me(this.subscription)?se:re`<gl-feature-badge
									placement="bottom"
		...
		>
			...
			</div>`}onChartDataPointClicked(e){this._ipc.sendCommand(Qe,e.detail)}onPeriodChanged(e){const t=e.target,o=t.options[t.selectedIndex].value;!function(e){if("all"===e)return;const[t,o]=e.split("|");if(isNaN(Number(t))||"D"!==o&&"M"!==o&&"Y"!==o)throw new Error(`Invalid period: ${e}`)}(o),this._ipc.sendCommand(Ye,{period:o})}};rn.shadowRootOptions={...lit_element_r.shadowRootOptions,delegatesFocus:!0},rn.styles=[Ht,Gt],on([we("#chart")],rn.prototype,"_chart",2),on([ve()],rn.prototype,"_loading",2),on([ve()],rn.prototype,"_zoomed",2),rn=on([ge("gl-timeline-app")],rn);var nn=s.A;export{nn as GlTimelineApp};